...
Los prototipos de las páginas fueron creados inicialmente mediante el uso de Stitch, para, a continuación, configurar los resultados utilizando Figma para obtener un sketch más unitario y fiel al resultado que buscábamos.
